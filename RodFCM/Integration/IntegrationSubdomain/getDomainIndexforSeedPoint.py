...
#from Integration.IntegrationSubdomain.getDomainIndex import getDomainIndex


def getDomainIndexForSeedPoint(seedPoint,support,indexGeometry):

    localCoord = mapLocalToGlobal(seedPoint, indexGeometry)
    globalCoord = mapLocalToGlobal(localCoord, support.global_coordinates)
